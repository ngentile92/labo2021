...
campos_lags  <- setdiff(  colnames(dataset) ,  c("clase_ternaria","clase01", "numero_de_cliente","foto_mes", campos_malos, campos_malos2, campos_malos3,
                                                 campos_malos4, campos_malos5,campos_malos6, campos_malos7, campos_malos8, campos_malos9,
                                                 campos_malos10,campos_malos11, campos_malos12) )
...
campos_buenos  <- setdiff( colnames(dataset), c("clase_ternaria","clase01", campos_malos, campos_malos2, campos_malos3,
                                                campos_malos4, campos_malos5,campos_malos6, campos_malos7, campos_malos8, campos_malos9, 
                                                campos_malos10, campos_malos11, campos_malos12))
