...
####Agregue varios campos malos y agregue lag_2
...
campos_malos  <- c( "mpasivos_margen", "cliente_antiguedad", "mrentabilidad_annual",
                    "mcuenta_corriente_adicional", "mcuenta_corriente", "mcaja_ahorro_adicional",
                    "mcaja_ahorro_dolares", "mcuentas_saldo", "mtarjeta_visa_consumo", 
                    "mtarjeta_master_consumo", "mplazo_fijo_dolares", "cpagomiscuentas",
                    "mtransferencias_recibidas", "Master_mfinanciacion_limite", 
                    "Visa_mfinanciacion_limite", "Visa_msaldopesos", "Visa_fultimo_cierre")   #aqui se deben cargar todos los campos culpables del Data Drifting
...
dataset[ , paste0( campos_lags2, "_lag2") := shift(.SD, 2, NA, "lag2"), 
         by= numero_de_cliente, 
         .SDcols= campos_lags2]
